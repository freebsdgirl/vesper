...
ACTION_DEFINITIONS: tuple[ActionDefinition, ...] = (
    ...
    _definition("steer_session", "Steer the active adaptive session.", "steer session", lambda service, params: service.steer_session(str(params["request"])), required_fields=("request",), session_aware=True),
    ...
    _definition("create_playlist", "Create a playlist.", "create playlist", lambda service, params: service.create_playlist(name=str(params["name"]), description=str(params["description"]) if params.get("description") is not None else None, track_refs=list(params.get("track_refs", [])) or None), required_fields=("name",)),
    _definition("add_playlist_tracks", "Add tracks to a playlist.", "add playlist tracks", lambda service, params: service.add_playlist_tracks(str(params["playlist_id"]), track_refs=list(params["track_refs"])), required_fields=("playlist_id", "track_refs")),
